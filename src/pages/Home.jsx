...
const Home = () => {
  ...
  return (
    <section className="relative w-full h-screen mt-24 p-4">
      ...
      <div id="about" className="w-full h-screen pt-24 px-10">
        ...
        <div className="mt-20 w-full h-fit flex justify-between gap-14">
          <div className="w-1/3 relative bg-[#7A1616] text-[#FBC33D] border-4 border-[#541313] p-8 rounded-xl">
            <h2 className="absolute top-4 left-1/2 -translate-x-1/2 w-fit px-4 py-1 text-center text-xl bg-[#7A1616] font-medium rounded-full border-4 border-[#FBC33D]">College Talkshow</h2>
            <div className="bg-white w-full h-60 mb-4 border-4 border-[#FBC33D] rounded-xs"></div>
          ...
          <div className="w-1/3 relative bg-[#7A1616] text-[#FBC33D] border-4 border-[#541313] p-8 rounded-xl">
            <h2 className="absolute top-4 left-1/2 -translate-x-1/2 w-fit px-4 py-1 text-center text-xl bg-[#7A1616] font-medium rounded-full border-4 border-[#FBC33D]">Bloom Expedition</h2>
            <div className="bg-white w-full h-60 mb-4 border-4 border-[#FBC33D] rounded-xs"></div>
          ...
          <div className="w-1/3 relative bg-[#7A1616] text-[#FBC33D] border-4 border-[#541313] p-8 rounded-xl">
            <h2 className="absolute top-4 left-1/2 -translate-x-1/2 w-fit px-4 py-1 text-center text-xl bg-[#7A1616] font-medium rounded-full border-4 border-[#FBC33D]">Campus Expo</h2>
            <div className="bg-white w-full h-60 mb-4 border-4 border-[#FBC33D] rounded-xs"></div>
      ...
      <div id="booklet" className="w-full h-screen pt-24 px-10">
